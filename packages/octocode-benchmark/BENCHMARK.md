...
| 5 | `benchmark/check-matrix.mjs` | `matrix:check` | No | No | ✅ | `benchmark/SUPPORT.md` |
...
Regenerate `SUPPORT.md` with the live matrix:
...
| Support matrix | `benchmark/SUPPORT.md` (regenerated by `yarn support:gen`) |

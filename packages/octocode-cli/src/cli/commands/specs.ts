...
export const COMMAND_SPECS: readonly CLICommandSpec[] = [
  {
    ...
    examples: [
      'cat packages/octocode-cli/src/cli/index.ts',
  ...
  },
  {
    ...
    examples: [
      'ls packages/octocode-cli/src --depth 2',
  ...
  },
  {
    ...
    examples: [
      'grep "executeDirectTool" packages/octocode-cli/src --type ts',
  ...
  },
  {
    ...
    examples: [
      'ast "eval($X)" packages/octocode-cli/src',
  ...
  },
  {
    ...
    examples: [
      'find "command-help" packages/octocode-cli/src --search both --ext ts',
  ...
  },
  {
    ...
    examples: [
      'binary out/octocode-cli.js --identify',
      'binary app.zip',

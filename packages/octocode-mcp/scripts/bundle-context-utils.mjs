#!/usr/bin/env node
/**
 * bundle-context-utils.mjs — copies the octocode-context-utils native .node binary
 ...
 *
 * Usage:
 *   node scripts/bundle-context-utils.mjs <platform> <outDir>
 *
...
// Map build:bin platform names → octocode-context-utils binary triple names
const PLATFORM_MAP = {
...
if (!platform || !outDir) {
  console.error('Usage: node scripts/bundle-context-utils.mjs <platform> <outDir>');
...
mkdirSync(join(outDir, 'runtime', 'context-utils'), { recursive: true });

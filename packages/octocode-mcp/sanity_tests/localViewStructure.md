# Sanity check — `localViewStructure`

> List a local directory tree.
>
> **Manual runtime checklist** — run each step against the live MCP tool (or `benchmark/github/scripts/call-tool.mjs localViewStructure '<queries-json>'`) and tick the box.

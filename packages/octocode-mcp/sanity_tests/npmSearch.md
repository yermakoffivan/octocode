# Sanity check — `npmSearch`

> Search the npm registry.
>
> **Manual runtime checklist** — run each step against the live MCP tool (or `benchmark/github/scripts/call-tool.mjs npmSearch '<queries-json>'`) and tick the box.

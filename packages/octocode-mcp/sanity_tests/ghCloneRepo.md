# Sanity check — `ghCloneRepo`

> Clone/materialize a repo (or sparse subtree) to disk.
>
> **Manual runtime checklist** — run each step against the live MCP tool (or `benchmark/github/scripts/call-tool.mjs ghCloneRepo '<queries-json>'`) and tick the box.

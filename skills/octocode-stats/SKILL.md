...
- Schema: [packages/octocode-shared/src/session/schemas.ts](https://github.com/bgauryy/octocode/blob/main/packages/octocode-shared/src/session/schemas.ts)
- Stats path: [packages/octocode-shared/src/paths.ts](https://github.com/bgauryy/octocode/blob/main/packages/octocode-shared/src/paths.ts)
